...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import4.interpolate(1,'My First Angular 2 App ',this.context.hello.world,'');
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/edota/Source/ng-demo-aot/app/app.component.ts class AppComponent - inline template',0,import8.ViewEncapsulation.None,styles_AppComponent,{})); }
